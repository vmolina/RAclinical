...
def main():
    ...
    selected_columns = ["baselineDAS", "Age", "Gender", "Drug"]
    ...
    params_grid = {
        'sumSVR': {
            ...
            'kernel_functions':[[cosine_similarity, cosine_similarity, DiracKernel, equal]],
...
if __name__ == "__main__":
    ...
    for model in results:
        write_results(os.path.join(OUTPUT,'results_treatVar_%s.csv'%model),results[model],ids)